...
func (b *Image) View() *tview.TreeView {
	root := tview.NewTreeNode(tview.TranslateANSI("image:" + boldWhite.Sprint(" anthony/my-sample-golang:0.1") + bold.Sprintf(" - 2878ca7ca986 (7 days ago)"))).SetColor(tcell.ColorDimGray)
